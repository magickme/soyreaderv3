...
var fetchSubreddit = function() {
    return __awaiter(void 0, void 0, void 0, function() {
        var redditUrl, res, redditData, redditLoad;
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    redditUrl = 'https://www.reddit.com/r/all/top.json?t=today&limit=5';
                ...
                case 2:
                    redditData = _a.sent();
                    redditLoad = redditData.data.children.map(function(redditData, index) {
                        return ({
                            id: index + 1,
